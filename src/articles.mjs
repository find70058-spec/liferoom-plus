...
,
  {
    ...
    category: "support",
    title: "경기도 반려동 지원금 신청대상·신청방법·금액 빠른 안내",
    description: "경기도 반려동 지원금은 취약가구와 1인가구 등의 반려동물 의료·돌봄 부담을 줄이는 지원사업입니다. 대상과 금액은 시군별 공고 확인이 필요합니다.",
    author: "Lsejin",
    ...
    html: `<h2 id="toc-0">경기도 반려동 지원금이란?</h2><p>경기도 반려동 지원금은 반려동물을 키우는 도민의 의료비, 돌봄비, 장례비 부담을 줄이기 위한 지원사업입니다. 주로 사회적 배려계층, 돌봄 취약가구, 일정 소득 기준을 충족하는 1인가구 등이 대상이 되며, 세부 기준은 거주 시군 공고에 따라 달라질 수 있습니다.</p><h2 id="toc-1">신청대상 핵심</h2><p>기본적으로 주민등록상 경기도에 거주하고 반려견 또는 반려묘를 양육하는 가구가 확인 대상입니다. 기초생활수급자, 차상위계층, 한부모가족, 중증장애인, 다문화가정, 중위소득 기준을 충족하는 1인가구 등이 포함될 수 있습니다. 반려견은 동물등록 여부가 확인될 수 있으므로 신청 전 등록 상태를 점검하는 것이 좋습니다.</p><h2 id="toc-2">지원금액 안내</h2><p>지원금은 보통 반려동물 1마리당 최대 20만원 범위에서 의료비, 돌봄 위탁비, 장례비 등에 사용할 수 있습니다. 다만 자부담 포함 여부, 가구당 지원 마릿수, 항목별 한도는 시군 예산과 공고에 따라 달라질 수 있어 최종 확인이 필요합니다.</p><h2 id="toc-3">신청방법</h2><ol><li>경기도 공식 안내 페이지 또는 거주지 시군 홈페이지에서 사업 공고를 확인합니다.</li><li>본인이 신청대상에 해당하는지 소득, 가구유형, 거주지 기준을 확인합니다.</li><li>신분증, 주민등록등본, 대상자 증빙서류, 동물등록 확인자료, 진료비 영수증 등 필요서류를 준비합니다.</li><li>거주지 시군 담당부서 또는 지정 접수처에 신청합니다.</li></ol><p>공식 안내는 경기도 홈페이지에서 확인할 수 있으며, 안내 주소는 https://www.gg.go.kr/contents/contents.do?ciIdx=1304&menuId=3085 입니다.</p>`
  }
];
